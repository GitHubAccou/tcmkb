...
public class BaseDao {
    ...
    public void insert(String statment,Map row) {
    	getSqlSession().insert(statment, row);
    }
     ...
     * @param rows 要删除的数据
     */
    public void deleteRows(String statement,List rows){
     ...
     * @param row
     */
    public void deleteRow(String statement,Map row){
        getSqlSession().delete(statement, row);
    }
    ...
    public void updateRow(String statement,Map<String,Object>row) {
    	getSqlSession().update(statement, row);
    }
